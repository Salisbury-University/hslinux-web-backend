...
test.group("PreferenceController", (group) => {
    ...
    //Testing GET request
    test("PreferenceController Good GET Request", async({ expect }, done: Function) => {
    ...
    test("PreferenceController GET Request Bad Auth", async({ expect }, done: Function) => {
    ...
    test("PreferenceController Good POST request", async({ expect }, done: Function) => {
        //Set token and auth header values
        const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1aWQiOiJjeGFyYXVzYSIsImlhdCI6MTY1MjIwMzIxM30.uod0RxPPdDdluWDjzycVjv4QC_pHxDNeMY76Nbg2Q6k";
        const auth = {
            Authorization: "Bearer ".concat(token),
    ...
    test("PreferenceController POST request Bad Input", async({ expect }, done: Function) => {
        //Set token and auth header values
        const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1aWQiOiJjeGFyYXVzYSIsImlhdCI6MTY1MjIwMzIxM30.uod0RxPPdDdluWDjzycVjv4QC_pHxDNeMY76Nbg2Q6k";
        const auth = {
            Authorization: "Bearer ".concat(token),
    ...
    test("PreferenceController POST request Bad Auth", async({ expect }, done: Function) => {
        //Set token and auth header values
        const token = "";
        const auth = {
            Authorization: "Bearer ".concat(token),
